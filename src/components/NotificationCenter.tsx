...
export function NotificationCenter() {
  ...
  return (
    <div className="relative">
      {/* Bildirim Butonu */}
      <button className="relative p-2 text-gray-600 hover:text-gray-800 dark:text-gray-300 dark:hover:text-gray-100">
      ...
      {/* Bildirim Listesi */}
      <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden z-50 border border-gray-100/60 dark:border-gray-700/30">
